...
exports.run = (client, message, params) => {
    if (message.channel.type !== "group") {
        ...
        var durm = (Durum == "online" ? ("<a:online:647108287984304129>") : (Durum == "offline" ? ("<a:offline:647108287623331854") : (Durum == "idle" ? ("<a:idle:647108287485050890>") : (Durum == "dnd" ? ("<a:dnd:647108287606685706>") : ("Bilinmiyor/bulunamadı.")))))
