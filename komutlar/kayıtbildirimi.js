...
exports.run = async (bot, message, args) => {
  ...
  if (!mentionedChannel && args[0] !== "sıfırla") return message.channel.send(`:x: Ayarlamam Için Log Kanalı Etiketlemelisin. Orn: \`!kayıt-bildirim-ayarla #logkanal\``);
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ['kayıt-bildirim-kanal-ayarla'],
  permlevel: 3
};

exports.help = {
  name: 'kayıt-bildirim-ayarla',
  description: 'otorol-ayarla',
  usage: 'kayıt-bildirim-kanal-ayarla'
};
